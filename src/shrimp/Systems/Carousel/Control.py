...
def make_control(control_name: str) -> Callable:
    ...
    setattr(module_obj, control_name, ctrl)
    setattr(Pattern, control_name, ctrl_pattern)

    return ctrl


for control_type, control_name, description in generic_params:
    make_control(control_name)


def create_param(param_name: str):
    """Creates a new control function with the given name"""
    return make_control(param_name)


def create_params(param_names: str):
    """Creates a new control functions from the given list of names"""
    return [make_control(name) for name in param_names]
